...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched Zypher UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "Zypher UI Documentation",
            description: "A comprehensive guide to Zypher UI",
