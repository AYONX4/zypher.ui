...
import { PlaceholdersAndVanishInputDemo } from "./placeHolderAndvanishInputDemo";
...
export function HeroSection() {
  const words = ["100+ UI Components", "Tailwind CSS", "shadcn/ui", "Modern React & Next.js"];  
      ...
      <div className="w-full lg:w-[45%] flex flex-col items-start text-left space-y-8">
        ...
        >
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] text-zinc-900 dark:text-zinc-100">
            Craft with{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-sky-400 to-sky-200 dark:from-sky-400 dark:via-sky-600 dark:to-sky-800">
              precision
            </span>
            <Cover>
              Build with{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-b from-blue-500 to-teal-400 dark:from-blue-400 dark:via-blue-600 dark:to-blue-800">
                ease
              </span>
            </Cover>
            .
          </h1>
          <div className="mt-6 text-base md:text-xl text-zinc-700 dark:text-zinc-300 max-w-lg">
            A curated collection of{" "}
         <FlipWords words={words} />
            crafted with{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-indigo-200 to-yellow-100 dark:from-indigo-400 dark:to-yellow-400">
              Tailwind CSS
            </span>{" "}
            and{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-b from-fuchsia-500 to-purple-500 dark:from-fuchsia-400 dark:to-purple-400">
              shadcn/ui
            </span>{" "}
